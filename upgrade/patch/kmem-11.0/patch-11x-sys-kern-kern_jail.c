-- -kern_jail.c - orig 2016 - 07 - 08 10 : 52 : 16.841896000 +
    0300 ++ +kern_jail.c 2016 - 10 - 14 22 : 59 : 48.154902000 + 0300 @ @-207,
    6 + 207, 8 @@
 	"allow.mount.fdescfs", "allow.mount.linprocfs",
    "allow.mount.linsysfs", +"allow.dev_io_access", +"allow.dev_dri_access",
}
;
...
@ @-226, 6 + 228, 8 @@
    ...
    "allow.mount.nolinsysfs", +"allow.nodev_io_access",
    +"allow.nodev_dri_access",
}
;
const size_t pr_allow_nonames_size = sizeof(pr_allow_nonames);

@ @-4065, 6 + 4069, 27 @ @ return (0);
