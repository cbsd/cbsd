...
- **Parser**: A recursive descent parser (`parser.c`).
- **Execution Engine**: Handled by `eval.c`.
- **Builtins**: Defined in `builtins.def` and processed by the `mkbuiltins` script to generate efficient dispatch code.
...
### SQL Integration
- **Files**: [sqlcmd.c](file:///home/dsewell/Projects/cbsd/bin/cbsdsh/sqlcmd.c)
...
- **Files**: [cbsdcmd.c](file:///home/dsewell/Projects/cbsd/bin/cbsdsh/cbsdcmd.c), [jail.c](file:///home/dsewell/Projects/cbsd/bin/cbsdsh/jail.c)
...
- **Files**: [cbsd_pwait.c](file:///home/dsewell/Projects/cbsd/bin/cbsdsh/cbsd_pwait.c), [cbsd_fwatch.c](file:///home/dsewell/Projects/cbsd/bin/cbsdsh/cbsd_fwatch.c)
...
- **File**: [spawn_task.c](file:///home/dsewell/Projects/cbsd/bin/cbsdsh/spawn_task.c)
- **Command**: `spawntask`
- **Features**:
...
- **File**: [mystring.c](file:///home/dsewell/Projects/cbsd/bin/cbsdsh/mystring.c)
...
- **Files**: [cbsdredis.c](file:///home/dsewell/Projects/cbsd/bin/cbsdsh/cbsdredis.c), [cbsdinflux.c](file:///home/dsewell/Projects/cbsd/bin/cbsdsh/cbsdinflux.c)
- **Features**:
