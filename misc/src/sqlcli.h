...
const struct jail_db jaildb_info[] = {
	...
	{ "jid", "integer default 0" }, { "path", "text default null" },
	...
	{ "slavenode", "text default null" }, { "baserw", "boolean default 0" },
	{ "mount_src", "boolean default 0" },
	{ "mount_obj", "boolean default 0" },
	{ "mount_kernel", "text default null" },
	{ "mount_ports", "boolean default 0" },
	{ "astart", "integer default 0" }, { "data", "text default null" },
	{ "vnet", "boolean default 0" }, { "applytpl", "boolean default 0" },
	{ "mdsize", "integer default 0" }, { "rcconf", "text default null" },
	{ "floatresolv", "boolean default 0" }, { "ver", "text default null" },
	{ "arch", "text default null" }, { "exec_start", "text default null" },
...
const struct inventory_db inventorydb_info[] = {
	...
	{ "mdtmp", "integer default 0", 1 }, { "repo", "text default null", 1 },
	{ "workdir", "text default null", 1 },
	{ "ipfw_enable", "boolean default 0", 1 },
	{ "fs", "text default null", 1 }, { "zfsfeat", "boolean default 0", 1 },
